...
send_to_server(json.dumps({"cmd": "ADD", "syn": 12, "name": "Sleep No More The Beauty", "data": p1}))
...
send_to_server(json.dumps({"cmd": "DEL", "syn": 12, "name": "Sleep No More The Beauty", "data": p1}))
